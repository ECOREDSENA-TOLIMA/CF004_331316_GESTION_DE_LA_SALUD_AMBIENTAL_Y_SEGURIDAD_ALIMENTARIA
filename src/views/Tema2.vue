  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-10.col-md-10.col-lg-10.desktop(data-aos="fade-right")
        ...
        figure
          img.mb-3(src='@/assets/curso/temas/tema2/img-9-1.svg', alt='La figura 11, grafica la relación que existe entre los objetivos de la atención primeria en salud, y la generación de ambientes favorables, que permitan el alcance de dichos objetivos.')
    ...
    .row.mt-5.mb-5
      .col-10.col-md-10.col-lg-10.movil(data-aos="fade-right")
        .titulo-sexto.color-acento-contenido
          p.titulo.pb-0.mb-0 #[b Figura 11.] <em>Lugar de la familia y la comunidad en el modelo de Atención Primaria en Salud </em>
        figure
          img(src='@/assets/curso/temas/tema2/img-9-2.svg', alt='La figura 11, grafica la relación que existe entre los objetivos de la atención primeria en salud, y la generación de ambientes favorables, que permitan el alcance de dichos objetivos.') 
